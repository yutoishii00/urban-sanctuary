...
const initiationFee = {
  ...
  description:
    "最高品質の時間と、完全なプライバシー保護のために。当クラブは厳格な会員制を採用しております。この入会金は、貴女と同じ社会的地位と品格を持つ方々だけのコミュニティを維持し、一切の不安がない環境を担保するためのお約束です。",
};
...
const tiers = [
  ...
  },
  {
    ...
    features: [
      { icon: Shield, text: "Goldの内容 — 会員資格の維持・厳格な審査を通過した証" },
