    ...
    <div className="min-h-screen bg-[#0B1021] text-[#E2E8F0]">
      ...
      >
        ...
        <div className="terms-body">
          ...
          <div className="taboo-list">
            <div className="taboo-item">
              <p>暴力団、暴力団員、暴力団準構成員、暴力団関係企業、総会屋、社会運動等標ぼうゴロ、特殊知能暴力集団、その他これらに準ずる者（以下「反社会的勢力」）であること</p>
            </div>
            <div className="taboo-item">
              <p>反社会的勢力と社会的に非難されるべき関係を有すること</p>
            </div>
            <div className="taboo-item">
              <p>反社会的勢力を利用していると認められること</p>
            </div>
            <div className="taboo-item">
              <p>反社会的勢力に対して資金等を提供し、または便宜を供与するなどの関与をしていると認められること</p>
            </div>
          </div>
          <p className="mt-6">
            利用者が前項の表明・保証に反した場合、当サービスは何らの催告を要することなく、直ちに利用契約を解除し、会員資格を取り消すことができるものとします。この場合、入会金および年会費の返金は一切行いません。
          </p>
          <p className="mb-16">
            当サービスは、本条に基づく解除により利用者に生じた損害について、一切の責任を負わないものとします。
          </p>
