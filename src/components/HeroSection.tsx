 ...
 * Diagnosis button opens DiagnosisModal
 */
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Diagnosis CTA — subtle, differentiated */}
            <motion.button
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => setIsDiagnosisOpen(true)}
              className="inline-flex items-center gap-2.5 px-8 py-3.5 text-[#E2E8F0]/50 hover:text-[#D4AF37]/80 font-serif text-[13px] tracking-[0.18em] border border-transparent hover:border-[#D4AF37]/20 hover:bg-[#D4AF37]/[0.04] transition-all duration-700 rounded-sm cursor-pointer"
            >
              <Sparkles size={14} strokeWidth={1.5} className="opacity-60" />
              相性診断（無料）
            </motion.button>
          </motion.div>
