    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <motion.button
          ...
          className="inline-flex items-center gap-3 px-10 py-4 border border-[#D4AF37]/40 text-[#D4AF37] font-serif text-sm tracking-[0.2em] uppercase hover:bg-[#D4AF37]/10 hover:border-[#D4AF37]/70 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] transition-all duration-700 rounded-sm"
        >
          キャストを見る
        </motion.button>
